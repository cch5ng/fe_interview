...
class TestForm extends Component {
  constructor(props) {
    ...
    this.getQuestionCountPerCategory = this.getQuestionCountPerCategory.bind(
      this
    );
  ...
  render() {
    let questionObj =
      this.props.questions && this.props.questions.questions
    ...
    if (questionObj) {
      ...
      questionsMaxObj = this.getQuestionCountPerCategory(
        questionsAr,
        questionCategories
      );
    }
    ...
    return (
      <div className={styles.testFormContainer}>
        {this.state.formSubmitted && <Redirect to={newTestUrl} />}
        ...
        <form className="new-test-form">
          ...
          <div className={styles.formGroup}>
            ...
            <select
              id="select-time-per-question"
              name="selectTimePerQuestion"
          ...
          <div>
            ...
            <div className={styles.testFormCategoriesContainer}>
              {questionCategories.map(category => {
                ...
                const maxQuestionCount = questionsMaxObj
                  ? questionsMaxObj[category]
                  : 0;
          ...
          <button id="button-create-test" onClick={this.handleFormSubmit}>
            Create
          </button>
        </form>
      </div>
